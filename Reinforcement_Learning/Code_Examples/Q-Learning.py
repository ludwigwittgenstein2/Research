...
# Initialize Q(s, a), for all s e S, a e A(s), arbitrarily, and Q(terminal-state) = 0
...
# Sutton's code pseudocode: Choose A from S using policy derived from Q (e.g., e-greedy)
